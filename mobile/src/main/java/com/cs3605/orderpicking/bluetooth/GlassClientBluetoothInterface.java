...
public class GlassClientBluetoothInterface {
    ...
    private static final String GLASS_MAC_ADDRESS = "f4:f5:e8:12:0f:d1";
    private static final String GLASS_2_MAC_ADDRESS = "f4:f5:e8:12:02:4d";
...
//        bluetoothHandler = handler;
    ...
    private void getGlassDevice() {
        ...
        for (BluetoothDevice device : pairedDevices) {
            if (device.getAddress().toLowerCase().equals(GLASS_2_MAC_ADDRESS)) {
                glassDevice = device;
                break;
            }
        }
